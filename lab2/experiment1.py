...
class Main(object):
    ...
    def run(self):
        ...
        for size in window_sizes:
            ...
            # run the simulation
            Sim.scheduler.run()
            print "currtime:",size,a.total_bits/Sim.scheduler.current_time()
            throughputs.append(a.total_bits/Sim.scheduler.current_time())
            print c1.timeouts

        # Graphing
        p = Plotter()
        p.linePlotData(window_sizes,throughputs,'Window Size','Throughput',"exp1")
